    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'rejected':
          ...
          break;
        case 'post_id':
          result.postId.replace(serializers.deserialize(value,
                  specifiedType: const FullType(
                      BuiltList, const [const FullType(String)]))!
              as BuiltList<Object?>);
          break;
...
class UsersRecordBuilder implements Builder<UsersRecord, UsersRecordBuilder> {
  ...
  ListBuilder<String>? _postId;
  ListBuilder<String> get postId =>
      _$this._postId ??= new ListBuilder<String>();
  set postId(ListBuilder<String>? postId) => _$this._postId = postId;
